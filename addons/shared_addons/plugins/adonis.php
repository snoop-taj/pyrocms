 ...
 *
 */
class Plugin_Adonis extends Plugin {
...
CAROUSEL;
    ...
    /*     * ************* Adonis special elements added by Yohan************** */
    ...
    function iconbox() {
        ...
        $html = '<div class="iconbox">
                    <a href="'.$link.'">
                        <ul>
                            <li><i class="'.$class.'" ></i></li>
                            <li class="iconbox-title"><h4>'.$title.'</h4></li>
                        </ul>
                        <p>'.$this->content().'</p>
                    </a>   
                </div>';
    ...
    function videoLightbox() {
        ...
        <div class="video-lightbox">
                <a href="'.$video_url.'" rel="prettyPhoto" title="'.$title.'" target="_blank">
                        <img alt="Video" src="{{ url:site }}files/large/'.$imageid.'/" />
                        <div class="overlay"></div>
                        <div class="lightbox-zoom"></div>
                </a>
        </div> 
